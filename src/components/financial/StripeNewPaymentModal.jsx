    ...
    <div className="pal-fin-modal-backdrop" role="dialog" aria-modal="true" onClick={(e) => e.target === e.currentTarget && onClose?.()}>
      <div className="pal-fin-modal pal-fin-modal-wide">
        ...
        <div className="pal-fin-modal-body pal-new-payment-choices">
          <button type="button" className="pal-new-payment-choice" onClick={() => setMode('deposit')}>
          ...
          <button type="button" className="pal-new-payment-choice" onClick={() => setMode('mailorder')}>
          ...
          <button type="button" className="pal-new-payment-choice" onClick={() => setMode('charge')}>
